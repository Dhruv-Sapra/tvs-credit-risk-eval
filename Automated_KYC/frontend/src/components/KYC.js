...
export const KYC = (props) => {
    ...
    return (
        <div className={"main_outer"}>{ isKycSuccess ? <SuccessKYC/> :
            <Container fluid className={"p-4 container-inner"}>
                ...
                <Row className={"m-2 p-4"}>
                    ...
                    <Col className="d-flex justify-content-center align-items-center"><button className={"btn btn-secondary"} onClick={capturePic}>Capture</button></Col>
                    <Col>
                ...
                <Row  className={"m-2 p-4"}>
                    ...
                    <Col className="d-flex justify-content-center align-items-center"><button className={"btn btn-secondary"} onClick={getGeolocation}>Locate Me</button></Col>
                    <Col><input placeholder={userLocation} className={"location-input"} disabled/></Col>
                </Row>
